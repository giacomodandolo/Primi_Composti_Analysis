...
The notebook which allows to simulate the game can be found [here](https://github.com/giacomodandolo/primi_composti/blob/main/PrimiComposti_Simulator.ipynb).
